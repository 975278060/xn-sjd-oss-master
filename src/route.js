...
const ROUTES = [
  ...
  // 系统管理 -- 审核通知人 -- 审核通知人
  {
    path: '/public/auditnotice',
    component: asyncComponent(() => import('container/public/auditnotice/auditnotice'))
  },
  // 系统管理 -- 审核通知人 -- 审核通知人
  {
    path: '/public/auditnotice/addedit',
    component: asyncComponent(() => import('container/public/auditnotice-addedit/auditnotice-addedit'))
  },
  // 系统管理 -- 广告位管理 -- banner管理
  {
    path: '/public/banner',
  ...
  // 业务管理 -- 情感频道 -- 详情
  {
    ...
    // 业务管理 -- 情感频道--官方文章管理
    {
        path: '/emotion/adminarticles',
        component: asyncComponent(() => import('container/biz/emotion/adminarticles/adminarticles'))
    },
  // 业务管理 -- 情感频道--官方文章管理--新增
  {
    path: '/emotion/adminarticles/addedit',
    component: asyncComponent(() => import('container/biz/emotion/adminarticles/adminarticles-addedit'))
  },
  // 业务管理 -- 道具管理 -- 道具管理
  {
    path: '/prop/props',
